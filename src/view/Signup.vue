                                ...
                                >
                                    <v-card class="elevation-12">
                                        <v-toolbar dark color="primary">
                                            <v-toolbar-title>Sign up with email</v-toolbar-title>
                                        </v-toolbar>
                                        <br>
                                        ...
                                        <v-card-text>
                                            <v-form>
                                                <v-text-field name="signup" label="Signup" type="text" ref="user_id" v-model="user_id"></v-text-field>
                                            </v-form>
                                        </v-card-text>
                                        <div class="text-center">
                                            <v-btn tile color="primary" type="submit" rounded @click="emailSignUp">
                                                <v-icon left>
                                                    mdi-email
                                                </v-icon>
                                                Continue
...
export default {
    ...
    created() {
        this.selectedImage = 'https://picsum.photos/id/' + parseInt(Math.random() * (1084 - 1) + 1) + '/200/300';
    },
    methods: {
        randomItem (items) {
        ...
        emailSignUp () {
            ...
            this.$store.dispatch('emailSignUpInit', params)
            .then((res) => {
        ...
        gmailSignUp () {
            ...
            .then(authCode => {
                ...
                this.$store.dispatch('gmailSignUpEnd', params)
                .then((res) => {
